...
public class AnimatorManager {
     ...
     * @param action   动画效果
     */
    public static ObjectAnimator startAnimotion(Object object, float start, float end, int duration, String action) {
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(object, action, start, end).setDuration(duration);
